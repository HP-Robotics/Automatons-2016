...
/*Copied from edu.wpi.wpilibj.PidController for customization purposes*/
/*----------------------------------------------------------------------------*/
 ...
 */
public class ATM2016PIDController implements PIDInterface, LiveWindowSendable, CANSpeedController {
  ...
  private class PIDTask extends TimerTask {
    ...
    public PIDTask(ATM2016PIDController controller) {
      if (controller == null) {
   ...
   *        default is 50ms.
   */
  public ATM2016PIDController(double Kp, double Ki, double Kd, double Kf, PIDSource source,
   ...
   *        default is 50ms.
   */
  public ATM2016PIDController(double Kp, double Ki, double Kd, PIDSource source, PIDOutput output,
      double period) {
  ...
  public void setInitialPower(double power, double timeMillis) {
	  m_initPower = power;
